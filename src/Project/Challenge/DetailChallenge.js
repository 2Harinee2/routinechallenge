...
import { useState, useEffect } from "react";
 ...
 import detail8 from "../image/detailChallenge/detail8.png" // 배너 좌측 이미지
 import detail9 from "../image/detailChallenge/detail9.png" // 챌린지 설명 이미지
 import detail7 from "../image/detailChallenge/detail7.png" // 인증 예시 이미지
...
function DetailChallenge() {
  ...
  return (
    ...
    <div className="forcenterdiv">
      ...
      <img className="image-explain-detail" alt="챌린지설명" src={detail9}>
      ...
      <div className="bottom-place"> 
            ...
            <tr>
              <td>
                <button class = "certify-button">
                  <img className="certify-image" alt="인증사진" src={detail7}></img>
        ...
        <div>
        <img className="detail-image" alt="" src={detail9}></img>
        </div>
