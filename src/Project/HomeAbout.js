...
import people from './image/HOME&ABOUT/people.png';
import routineClear2 from './image/HOME&ABOUT/routine_clear2.png';
import challenge from './image/HOME&ABOUT/challenge.png';
      ...
      <section id='about'>
        <div className='con01'><a href="/challenge">
          <ul>
            ...
            <li className='c01-right'><img src={people} alt='people' /></li>
          </ul>
        </a></div>
        ...
        <div className='con02'>
          ...
          <div class="marquee">
            <div>
              <span><img src={challenge} alt='challenge' /></span>
              <span><img src={challenge} alt='challenge' /></span>
            </div>
          </div>
        </div>
        ...
        <div className='con03'><a href="/myPage">
          <ul>
            <li className='c03-left'><img src={routineClear2} alt='MyRoutine' /></li>
